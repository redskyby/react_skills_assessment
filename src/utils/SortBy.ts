...
export default function SortBy(data: CoinDataResponse, sortItem: string) {
    ...
    switch (sortItem) {
        ...
        case '2':
            ...
            sortData_marketCapUsd.sort(
                (a: CoinData, b: CoinData) => parseFloat(b.marketCapUsd) - parseFloat(a.marketCapUsd),
            );
        ...
        case '3':
            ...
            sortData_changePercent24Hr.sort(
                (a: CoinData, b: CoinData) => parseFloat(b.changePercent24Hr) - parseFloat(a.changePercent24Hr),
            );
